...
INSERT INTO `offres` (`idOffre`, `nomOffre`, `description`, `photo1`, `photo2`, `photo3`, `nomRubrique`, `niveau`, `contact`, `nomInstrument`) VALUES
	('1', 'Cours de flute', 'Cours de flute traversière pour tous niveaux.', "placeholder_200.png", NULL, NULL, 'Enseignements', 'Tous', 'contact@mjcrodez.fr', 'Flûte'),
	('2', 'Cours de piano', 'Cours de piano traversière pour tous niveaux.', "placeholder_200.png", NULL, NULL, 'Enseignements', 'Débutant', 'contact@mjcrodez.fr', 'Piano'),
	('3', 'Diffusion', 'jsp ce que c\'est', "img1.jpg", "img2.jpg", "img3.jpg", 'Diffusion', 'Tous', 'lisa@contact.fr', NULL),
