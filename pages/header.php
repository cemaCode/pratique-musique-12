<header>
    <script>
        ...
        function showHideMenuOnClick() {
            x = document.querySelectorAll('li')
            for (let index = 0; index < x.length; index++) {
                if (x[index].id != "logo")
                    if (x[index].style.visibility == 'hidden') {
                        x[index].style.visibility = "visible"
                    } else {
                        x[index].style.visibility = "hidden"
                    }
        ...
        window.onresize = showHideMenu; window.onload = showHideMenu;
    </script>
...
<!--    <h1><a href="/pratique-musique-12/index.php"><img src="/pratique-musique-12/images/logo.png"></a></h1>-->

    <nav id="navbar">
        <ul>
            <li id="logo">
                <a href="/pratique-musique-12/index.php"><img src="/pratique-musique-12/images/logo.png" ></a>
            </li>
            <li>
            ...
            <li class="deroulant">
                <a class='deroulant' href="/pratique-musique-12/pages/rubriques.php">
                    Rubriques
            ...
            <li>
                <a id='recherche' href="/pratique-musique-12/pages/recherche.php">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 513.749 513.749" width="16"
        ...
        <a class='icon' href="javascript:void(0);" onclick="showHideMenuOnClick()">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" height="16" width="16">
                <path d="m24 30.75-12-12 2.15-2.15L24 26.5l9.85-9.85L36 18.8Z"/>
            </svg>
        </a>
